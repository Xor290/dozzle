...
type NotificationDispatcher struct {
	...
	// Telegram fields
	BotToken      string `protobuf:"bytes,10,opt,name=bot_token,json=botToken,proto3" json:"bot_token,omitempty"`
	ChatId        int32  `protobuf:"varint,11,opt,name=chat_id,json=chatId,proto3" json:"chat_id,omitempty"`
...
func (x *NotificationDispatcher) GetChatId() int32 {
	if x != nil {
		return x.ChatId
	}
	return 0
...
func (x *NotificationDispatcher) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
const file_types_proto_rawDesc = "" +
	...
	" \x01(\tR\x0feventExpression\"\xe5\x02\n" +
	...
	"\aheaders\x18\x06 \x03(\v2-.protobuf.NotificationDispatcher.HeadersEntryR\aheaders\x12\x1b\n" +
	"\tbot_token\x18\n" +
	" \x01(\tR\bbotToken\x12\x17\n" +
	"\achat_id\x18\v \x01(\x05R\x06chatId\x12\x18\n" +
	...
	"\n" +
	"\x06Remove\x10\x03B,Z*github.com/amir20/dozzle/internal/agent/pbb\x06proto3"
